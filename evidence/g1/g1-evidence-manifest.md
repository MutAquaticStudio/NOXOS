...
| Remote foundation CI                                                               | PASS for its immutable SHA only | GitHub Actions run `33139089132` passed `foundation`, `browser-foundation`, and `cloud-migration-replay` for `84ed4392431175d6060674b728ec6f8c8b88db4e`. Earlier run `33136145538` passed for `c6dc5aabb354b699f1b57e6ea3f60f9da41c9bf1`. Neither run is deployment evidence or reusable for a later source SHA. |
| Vercel Git deployment                                                              | FAIL                            | Vercel Git integration created deployment `EJt8gy6pfgz2rT4dZa5kxKfeLfNv` for the current candidate, but returned failure with no usable Preview URL.                                                                                                                                                             |
...
| `VERCEL_PREVIEW`                            | FAIL                     | Vercel deployment `EJt8gy6pfgz2rT4dZa5kxKfeLfNv` failed before a usable Preview URL, shell, health check, or SHA read-back was available.                                                                                                             |
