...
| Remote foundation CI                                                               | PASS for its immutable SHA only | GitHub Actions run `33139450543` passed `foundation`, `browser-foundation`, and `cloud-migration-replay` for `07bd0b8ba84d4fa0e992f512a559e1cda0cf821e`. Earlier runs `33139089132` and `33136145538` passed for their own SHAs. None is deployment evidence or reusable for a later source SHA. |
| Vercel Git deployment                                                              | FAIL                            | Vercel Git integration failed current deployment `AH4X4Q1N9UNC3KPs56q8Z91CPtBt` and prior candidate deployment `EJt8gy6pfgz2rT4dZa5kxKfeLfNv`, with no usable Preview URL.                                                                                                                       |
...
| `VERCEL_PREVIEW`                            | FAIL                     | Current Vercel deployment `AH4X4Q1N9UNC3KPs56q8Z91CPtBt` failed before a usable Preview URL, shell, health check, or SHA read-back was available; the immediately preceding candidate failed too.                                                     |
