...
if (!outputPath || !sha || !previewUrl || !/^[0-9a-f]{40}$/i.test(sha))
  throw new Error("G6 Preview evidence requires an output path, exact SHA, and Preview URL.");

const fields = {
  GOAL_ID: "NOX-OS-GATE-6-RELEASE-READINESS",
  EVIDENCE_SCHEMA: "G6-PREVIEW-1.0",
  PR_SOURCE_SHA: sha,
...
console.log("G6_PREVIEW_EVIDENCE=WRITTEN");
