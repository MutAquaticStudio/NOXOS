...
const forbiddenBundleValues =
  /(SUPABASE_SERVICE_ROLE_KEY|NOX_(RUNTIME|MIGRATION)_DATABASE_URL|TURNSTILE_SECRET_KEY|CF_API_TOKEN|VERCEL_TOKEN|NOX_(WORKFLOW_PROBE|DIAGNOSTIC_PROBE)_TOKEN)/;
