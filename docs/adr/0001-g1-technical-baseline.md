...
| Database client  | postgres.js 3.4.9 with prepared statements disabled for transaction pooling; 5s connection, 10s idle, and 60s lifetime policy                |
...
| Performance      | Lazy module routes, 350 kB Vite chunk warning, 8s API response budget, and 10s Vercel Function cap                                           |
